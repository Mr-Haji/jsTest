// Q no 1 Type the characters that are missing from this code.
...
// var firstAlp = cityName[0].toUpperCase() 
// var restAlp = cityName.slice(1)toLowerCase() 
// cityName=firstAlp + restAlp
// ====================Ch No 22 To 25======================================
...
// Answer:
// var text = "To go or not ty ui gt ft gfd  to go.";
// a = text.length
...
// Answer:
// var input = "09876543212123456789"
...
// Answer:/ var str = "1 shoud not do this";
...
//    Answer:/ var num = Math.random().toFixed(4);
...
// Answer:/ var a = Math.random().toFixed(2).toString();
// a = parseInt(a)
...
// Answer:/ var num = 23.45687512.toFixed(2).toString();
// if(num.length === 4)
...
//         Answer:       // var dayOfWeek = ["sunday","monday","tuesday", "wednesday","thursday","friday","saturday"]
//         var dObj = new Date();
//         var d = dObj.getDay();
...
//         Answer:       // 7. Create a Date object for the second day of the second month of 1992 and assign it to a variable that hasn't been declared beforehand.
//         Answer:       // var later = new Date(1992,1,2)
...
// Answer:/ function concat(m, string, num){
//  alert(m + string + num);
//  }
...
// Answer:/ function userName(firstName, lastName){
...
// Answer:/ var word = "skgkjsdgjkjgkdjs";
// function count (word){
//     return word.length
// }
// count(word)
...
// Answer:/ array = ['zaid','haris','raza','abubakar','hassan','hussain','fatima']
// function find(){
...
// Answer:/ var dayOfWk = ["sun","sat","Mon"]
// switch(dayOfWk) {
//      case "Sat" :
//      alert("Whoopee");
//      break;
...
// Answer:/ var cityName = prompt("enter city");
// switch(cityName){
//     case "Lahore":
//         console.log("welcome to Lahore");
//         break;
//         default :
//         console.log("you are not in Lahore")
// }
